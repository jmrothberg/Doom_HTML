                            ...
                            if (data.monsters) {
                                data.monsters = data.monsters.map((networkMonster, i) => {
                                    ...
                                    return {
                                        ...
                                        animState: networkMonster.animState ?? localMonster.animState,
                                        animFrameIndex: networkMonster.animFrameIndex ?? localMonster.animFrameIndex,
                                        animTime: networkMonster.animTime ?? localMonster.animTime,
                                        pendingRemove: networkMonster.pendingRemove,
                                        lastX: localMonster.lastX,
                                        lastY: localMonster.lastY,
                                        _movedCache: localMonster._movedCache
                                    };
                                });
                                this.game.monsters = data.monsters;
                            }
